...
if (localStorage.UIstate) {
  ...
  app.config.globalProperties.$APIurl = UIstate.APIurl || "https://giaf90w7si.execute-api.localhost.localstack.cloud:4566/Prod"
    ...
    try {
      Amplify.configure({
        Auth: {
          ...
          userPoolId: "us-east-1_765d534c179c45cdafe0600e8072d9d9",
          userPoolWebClientId: "3hy9lol2a7yd574k2ppnhrnx2r",
          mandatorySignIn: false,
          // authenticationFlowType: 'CUSTOM_AUTH',
